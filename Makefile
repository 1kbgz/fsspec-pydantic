...
lint-py:  ## lint python with ruff
	python -m ruff check fsspec_pydantic
	python -m ruff format --check fsspec_pydantic
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix fsspec_pydantic
	python -m ruff format fsspec_pydantic
...
test:  ## run python tests
	python -m pytest -v fsspec_pydantic/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v fsspec_pydantic/tests --cov=fsspec_pydantic --cov-report term-missing --cov-report xml
